...
void TMVAAshleyDist() {
TFile* outputFile = TFile::Open( "TMVAVarDistBarXY_mS5.root", "RECREATE" );

TMVA::Factory* factory = new TMVA::Factory( "TMVA Analysis", outputFile);

TFile *input1 = TFile::Open( "/afs/cern.ch/user/c/calpigia/eos/public/forAshley/mc16ade_13TeV.311310.MadGraphPythia8EvtGen_A14NNPDF31LO_HSS_LLP_mH125_mS5_lthigh_DIST_BAR_NEW.root"  );
...
TFile *input2 = TFile::Open("/afs/cern.ch/user/c/calpigia/eos/public/forAshley/data15_13TeV.physics_Main_DIST_BAR_NEW.root" );
...
TMVA::TMVAGui("TMVAVarDistBarXY_mS5.root");
